...
const config = {
  container: process.env.REALTYOS_PG_CONTAINER || "platform-postgres",
  database: process.env.REALTYOS_PG_DATABASE || "platform",
  user: process.env.REALTYOS_PG_USER || "platform",
  password: process.env.REALTYOS_PG_PASSWORD || "platform_dev_password",
...
console.log("Local PostgreSQL is ready for the supported housing platform.");
