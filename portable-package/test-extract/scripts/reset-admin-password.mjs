...
const password = process.env.REALTYOS_RESET_ADMIN_PASSWORD || "AdminTemp2026!";
const email = process.env.REALTYOS_RESET_ADMIN_EMAIL || "admin@realtyos.local";
...
console.log(`Admin password reset for ${email}: ${password}`);
